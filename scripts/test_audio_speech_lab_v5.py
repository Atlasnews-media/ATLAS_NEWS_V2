...
check(
    ...
    "El IPC decidirá si ese reajuste de expectativas se consolida.",
)
check(
...
check(
    ...
    "El reajuste de expectativas de inflación cambió el escenario.",
)
check(
    "La repricing del mercado fue rápida.",
    "El reajuste de precios del mercado fue rápida.",
)
check(
...
expected_speech = (
    "El índice de precios al consumidor decidirá si ese reajuste de expectativas "
