...
**Fecha efectiva del contrato de cinco highlights: 2026-09-14.** Las ediciones General diarias anteriores a esa fecha quedan bajo grandfathering histórico y no deben reescribirse sólo para satisfacer el contrato actual. En particular, la edición del 2026-09-13 conserva sus cuatro highlights publicados. Los consumidores V2 actuales deben fallar cerrado si una reconstrucción histórica no cumple cinco highlights; no pueden fabricar, completar ni sustituir un quinto elemento. Cualquier reconstrucción excepcional de una edición histórica incompatible se trata como trabajo manual especial y no como ejecución del pipeline diario vigente.
