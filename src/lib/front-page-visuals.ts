...
const CHILE_CONSTRUCTION_KEYWORDS = [
  "construccion",
  "obra",
  "obras",
  "edificio",
...
const HUMANITARIAN_DISTRIBUTION = commonsVisual({
  file: "U S Army Soldiers Assist Panamanian Partners with Humanitarian Aid Distribution (9778658).jpg",
  alt: "Distribución de ayuda humanitaria y cajas de asistencia durante una operación regional.",
  source: "Wikimedia Commons / U.S. Southern Command",
  author: "Pfc. Oshon Trowbridge",
  license: "Dominio público — gobierno federal de EE.UU.",
  keywords: HUMANITARIAN_KEYWORDS,
});

const HUMANITARIAN_AID = commonsVisual({
  file: "Humanitarian aid DVIDS237445.jpg",
  alt: "Operación de entrega de ayuda humanitaria coordinada por personal militar.",
  source: "Wikimedia Commons / U.S. Army",
  author: "U.S. Army",
  license: "Dominio público — gobierno federal de EE.UU.",
  keywords: HUMANITARIAN_KEYWORDS,
});

const REFUGEE_ASSISTANCE = commonsVisual({
  file: "Desplazadoscol01.jpg",
  alt: "Asistencia humanitaria a personas refugiadas y desplazadas internas.",
...
const HUMANITARIAN_AIRDROP = commonsVisual({
  file: "Humanitarian Aid Airdrops (8302678).jpg",
  alt: "Operación aérea de lanzamiento de ayuda humanitaria.",
  source: "Wikimedia Commons / U.S. Army",
  author: "U.S. Army",
  license: "Dominio público — gobierno federal de EE.UU.",
  keywords: HUMANITARIAN_KEYWORDS,
...
const FEMA_RELIEF = commonsVisual({
  file: "FEMA - 37694 - FEMA Disaster relief supplies staged in Louisiana.jpg",
  alt: "Suministros de emergencia y ayuda para desastres preparados por FEMA.",
  source: "Wikimedia Commons / FEMA",
  author: "FEMA",
  license: "Dominio público — gobierno federal de EE.UU.",
  keywords: DISASTER_KEYWORDS,
});

const WAR_DAMAGE = commonsVisual({
  file: "Mitrovica damaged buildings 1999.jpg",
  alt: "Edificios dañados por un conflicto armado en un entorno urbano.",
  source: "Wikimedia Commons / NATO",
  author: "NATO",
  license: "Dominio público",
  keywords: CONFLICT_KEYWORDS,
});

const WAR_DAMAGE_ALT = commonsVisual({
  file: "A War-damaged Building (BOND 0564).jpg",
  alt: "Edificio severamente dañado por acciones de guerra.",
  source: "Wikimedia Commons / U.S. Army",
  author: "Frank Bond",
  license: "Dominio público — gobierno federal de EE.UU.",
  keywords: CONFLICT_KEYWORDS,
...
const MILITARY_HUMANITARIAN = commonsVisual({
  file: "Soldiers search for weapons and give humanitarian aid DVIDS37090.jpg",
  alt: "Soldados durante una operación de seguridad y asistencia humanitaria.",
  source: "Wikimedia Commons / U.S. Department of Defense",
  author: "Spc. Olanrewaju Akinwunmi",
  license: "Dominio público — gobierno federal de EE.UU.",
  keywords: [...CONFLICT_KEYWORDS, ...HUMANITARIAN_KEYWORDS],
});

const CHILE_TC = commonsVisual({
  file: "Edificio Tribunal Constitucional Chile.jpg",
  alt: "Edificio del Tribunal Constitucional de Chile en Santiago.",
  author: "Warko",
  license: "CC BY-SA 4.0",
  keywords: CHILE_JUSTICE_KEYWORDS,
});

const CHILE_TC_2015 = commonsVisual({
  file: "Tribunal Constitucional de Chile, 2015.jpg",
  alt: "Sede del Tribunal Constitucional de Chile en Santiago.",
  author: "Warko",
  license: "CC BY-SA 4.0",
  keywords: CHILE_JUSTICE_KEYWORDS,
});

const MINVU_BUILDING = commonsVisual({
  file: "Edificio del Ministerio de Vivienda y Urbanismo, Santiago 20230306.jpg",
  alt: "Edificio del Ministerio de Vivienda y Urbanismo en Santiago.",
  author: "Carlos yo",
  license: "CC BY-SA 4.0",
  keywords: CHILE_MINISTRY_KEYWORDS,
});

const CHILE_CONSTRUCTION_PROVIDENCIA = commonsVisual({
  file: "Construcción edificio, Providencia, Santiago 20240820.jpg",
  alt: "Construcción de un edificio en Providencia, Santiago.",
  author: "Carlos yo",
  license: "CC BY-SA 4.0",
  keywords: CHILE_CONSTRUCTION_KEYWORDS,
});

const CHILE_CONSTRUCTION_GAM = commonsVisual({
  file: "2017 Santiago de Chile - Construcción del Centro Gabriela Mistral (GAM) - Avenida Libertador Bernardo O'Higgins 227.jpg",
  alt: "Obras de construcción del Centro Gabriela Mistral en Santiago.",
  author: "Dietmar Rabich",
  license: "CC BY-SA 4.0",
  keywords: CHILE_CONSTRUCTION_KEYWORDS,
});

const CHILE_COSTANERA_CONSTRUCTION = commonsVisual({
  file: "Costanera Center en construcción (2008-12-3), 2.jpg",
  alt: "Construcción del complejo Costanera Center en Santiago.",
...
const CHILE_CCHC = commonsVisual({
  file: "Edificio Cámara Chilena de la Construcción, Las Condes, Santiago 20220417.jpg",
  alt: "Edificio de la Cámara Chilena de la Construcción en Las Condes, Santiago.",
  author: "Carlos yo",
  license: "CC BY-SA 4.0",
  keywords: CHILE_CONSTRUCTION_KEYWORDS,
});

const SANTIAGO_OFFICE_BUILDING = commonsVisual({
  file: "Building in Santiago de Chile.jpg",
  alt: "Edificio de oficinas en Las Condes, Santiago de Chile.",
  source: "Wikimedia Commons / Flickr",
...
const SANTIAGO_CCU_BUILDING = commonsVisual({
  file: "CCU building in Santiago.jpg",
  alt: "Edificio corporativo de CCU en Santiago de Chile.",
  author: "Usuario de Wikimedia Commons",
  license: "CC BY-SA 4.0",
  keywords: CHILE_URBAN_KEYWORDS,
});

const PLAZA_CONSTITUCION = commonsVisual({
  file: "Plaza de la Constitución Chile.jpg",
  alt: "Plaza de la Constitución y edificios del centro cívico de Santiago.",
  author: "Usuario de Wikimedia Commons",
  license: "CC BY-SA 4.0",
  keywords: CHILE_INSTITUTION_KEYWORDS,
});
